  ...
  <div class="project-detail">
    <div class="project-container">
      <div v-if="project" class="project-content">
        ...
        <h1 class="project-title">{{ getLocalizedProjectTitle(project.id) }}</h1>
        ...
        <div class="project-description">
          <h3 class="project-description-title">{{ $t('projects.description') }}</h3>
          <p v-if="project.description" v-html="getLocalizedProjectDescription(project.id).replace(/\n/g, '<br>')">
          </p>
          <p v-else>
      ...
      <div v-else class="project-not-found">
        ...
        <router-link to="/projects" class="back-button"
          >{{ $t('projects.backToProjects') }}</router-link
        >
      </div>
    </div>
  </div>
...
onMounted(() => {
  if (project.value) {
    document.title = `${getLocalizedProjectTitle(project.value.id)} | Portfolio`;
  } else {
